...
class ChangeAssigner(nn.Module):
    ...
    def assign(
        self, bboxes, targets, num_level_bboxes, feature, gt_bboxes_ignore=None):
        """Assign gt to bboxes.
        ...
        pred_boxes = yolo_decode(feature, bboxes)
        pred_overlaps = iou_xyxy_torch(pred_boxes, gt_bboxes)
        # assign 0 by default
        ...
        change_overlaps = pred_overlaps[candidate_idxs, torch.arange(num_gt)]
        is_pos = change_overlaps > candidate_overlaps
